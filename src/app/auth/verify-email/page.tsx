  ...
  return (
    <div className={styles.container}>
      <div className={styles.card}>
        ...
        {status === "loading" && <div style={{textAlign:"center",padding:"32px 0"}}><p style={{color:"#6b7280"}}>Verificando tu email...</p></div>}
        {status === "success" && (
          <div style={{textAlign:"center",padding:"16px 0 32px"}}>
            ...
            <Link href="/auth/login" style={{display:"inline-block",background:"#1e3a5f",color:"white",padding:"12px 32px",borderRadius:8,textDecoration:"none",fontWeight:600}}>Iniciar sesion</Link>
          </div>
        )}
        {status === "expired" && (
          <div style={{textAlign:"center",padding:"16px 0 32px"}}>
            <h2 style={{color:"#111827",fontSize:"1.3rem",marginBottom:12}}>Enlace expirado</h2>
            <p style={{color:"#4b5563",marginBottom:28}}>El enlace expiro. Registrate nuevamente.</p>
            <Link href="/auth/registro" style={{display:"inline-block",background:"#1e3a5f",color:"white",padding:"12px 32px",borderRadius:8,textDecoration:"none",fontWeight:600}}>Volver a registrarse</Link>
          </div>
        )}
        {status === "error" && (
          <div style={{textAlign:"center",padding:"16px 0 32px"}}>
            ...
            <Link href="/auth/login" style={{display:"inline-block",background:"#1e3a5f",color:"white",padding:"12px 32px",borderRadius:8,textDecoration:"none",fontWeight:600}}>Ir al login</Link>
          </div>
        )}
      </div>
    </div>
